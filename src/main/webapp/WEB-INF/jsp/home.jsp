...
<html>
    <head>
        ...
        <%String var= request.getParameter("styl");%>
        ...
        <link href="config/css/bootstrap.min<%= var.equals("1") ? "_1" : ""%>.css" rel="stylesheet">
        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    ...
                    <nav class="navbar navbar-default navbar<%= var.equals("1") ? "inverse" : ""%>-inverse" role="navigation">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                 <li class="dropdown">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Styl<strong class="caret"></strong></a>
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="?styl=1">Klasyczna biel</a>
                                                </li>
                                                <li class="divider">
                                                </li>
                                                <li>
                                                    <a href="?styl=2">Awangardowa zieleń</a>
                                                </li>
                                            </ul>
                                        </li>
                                <c:choose>
